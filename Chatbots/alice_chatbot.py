# -*- coding: utf-8 -*-
"""
Created on Sat Aug  4 19:17:54 2018
...
textDirectory = "C:/Users/Administrator/Dropbox/Python/deep_learning/book_texts/one_book"
...
SEQLEN = 75 # Important hyperparameter??
STEP = 2
input_chars = []
label_chars = []
...
model = Sequential()
model.add(SimpleRNN(HIDDEN_SIZE, return_sequences=False, # Return sequence is 
...
def completeSentence():
    rawInput = input('Say something at least 50 characters long: \n')
