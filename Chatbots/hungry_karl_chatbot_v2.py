...
Hungry Karl V2 - Uses a LSTM-style RNN trained on The Communist Manifesto, and 
an old book about the chemistry of cooking.

V2 has a sequence length of 150 and a larger batch size. Hopefully it will pick
up longer sentence structures and groups of sentences.
...
textDirectory = "C:/Users/Administrator/Dropbox/Python/deep_learning/book_texts/hungry_karl"
...
HIDDEN_SIZE = 128*6 # This is an important hyperparameter
BATCH_SIZE = int(HIDDEN_SIZE/2)
NUM_ITERATIONS = 30
